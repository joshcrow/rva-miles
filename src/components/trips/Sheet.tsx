...
// Shared bottom-sheet chrome for the trips screen's sheets. Self-contained
// copy of the home screen's Sheet chrome (not imported cross-workstream) so
// this screen has no dependency on another owner's private module.
